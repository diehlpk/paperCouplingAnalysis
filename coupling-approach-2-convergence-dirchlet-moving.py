...
if case == "Exact" :
    ...
    plt.savefig("coupling-"+example.lower()+"-approach-2-convergence-exact-direchlet-moving-"+factor+".pdf",bbox_inches='tight')

else :

    plt.ylabel("Error in displacement w.r.t, FDM")
    plt.savefig("coupling-"+example.lower()+"-approach-2-convergence-fdm-direchlet-moving-"+factor+".pdf",bbox_inches='tight')