...
def Coupling4(n,h):
    ...
    M[2*n+4][2*n+1] = 2 / 6 / h
    M[2*n+4][2*n+2] = -9 / 6 / h
    M[2*n+4][2*n+3] = 18 / 6 / h
    M[2*n+4][2*n+4] = -11 / 6 / h

    M[2*n+4][2*n+9] = -11 / 6 / h
    M[2*n+4][2*n+10] = 18 / 6 / h
    M[2*n+4][2*n+11] = -9 / 6 / h
    M[2*n+4][2*n+12] = 2 / 6 / h
...
def Coupling8(n,h):
    ...
    M[2*n+8][2*n+5] = 2 / 6 / h
    M[2*n+8][2*n+6] = -9 / 6 / h
    M[2*n+8][2*n+7] = 18 / 6 / h
    M[2*n+8][2*n+8] = -11 / 6 / h

    M[2*n+8][2*n+17] =  -11 / 6 / h
    M[2*n+8][2*n+18] = 18 / 6 / h
    M[2*n+8][2*n+19] =  -9 / 6 / h
    M[2*n+8][2*n+20] = 2 / 6 / h
